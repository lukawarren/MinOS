...
set (USERSPACE_FLAGS "-I ${CMAKE_CURRENT_SOURCE_DIR}/../musl/include -I ${CMAKE_CURRENT_SOURCE_DIR}/../musl/obj/include -I ${CMAKE_CURRENT_SOURCE_DIR}/../musl/arch/i386/ -I ${CMAKE_CURRENT_SOURCE_DIR}/../musl/arch/generic/ -I ${CMAKE_CURRENT_SOURCE_DIR}/../minlib/include")
