...
pub fn init()
{
    unsafe
    {
        ...
        let offset = 0x20;
        GLOBAL_IDT.entries[offset + 0]  = idt::Entry::new(on_pit_interrupt, 0x8, Attributes::ENABLED_RING_0_INTERRUPT);
    ...
    // Setup PIC and PIT
    pic::init(pic::PIC_MASK_PIT_AND_KEYBOARD, pic::PIC_MASK_NONE);
    pit::init();
}
