...
namespace memory
{
    ...
    Optional<size_t> allocate_for_user(const Optional<VirtualAddress> address, const size_t size, PageFrame& page_frame, const size_t flags = USER_PAGE);
    Optional<size_t> allocate_for_user(const size_t size, PageFrame& page_frame, const size_t flags = USER_PAGE);
